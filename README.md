...
Welcome to the Secure Health API. This is a backend application built with Go (golang) and PostgreSQL, designed to run seamlessly in a Dockerized environment.
...
```bash
git clone git@github.com:toni-calvin/secure-health-api.git
